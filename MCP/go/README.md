# NFL v3 Play-by-Play MCP Server

This MCP (Model Content Protocol) server provides access to NFL v3 Play-by-Play API functionality through HTTP, HTTPS, and STDIO transport modes.
